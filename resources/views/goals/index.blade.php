<!-- 子ビューに個別のコードを書くときはまず、@extendsというディレクティブを使ってベースとなる親ビューを指定します。ファイル名の指定方法はコントローラで使ったview()ヘルパーと一緒 resources/viewsを省略し、フォルダ名.ファイル名（.blade.phpは不要）と記述します。今回の場合は@extends('layouts.app') -->
@extends('layouts.app')
